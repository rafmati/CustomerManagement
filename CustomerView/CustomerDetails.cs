...
{
    internal sealed class CustomerDetails : ICustomerView
    {
        ...
        public CustomerDetails(int id_, string personalNum_, string name_, string lastName_, decimal totalDebt_, string notes_)
        {
            this.ID = id_;
        ...
        {
            CustomerDetails ex = obj as CustomerDetails; //comparing for object equality, higher probability of uniqueness first
            return !(ex == null ||
                ex.ID == this.ID ||
